...
$(document).ready(function () {
  ...
  var chart = new ApexCharts(document.querySelector("#gradientDonut1"), options);
  chart.render();
  var paper = chart.paper(); // donut with Pattern
  ...
  var options = {
    ...
    series: [4.36, 86.44, 5.47, 3.74, 91.90, 3.74],
    labels: ["ONGC", "YESBANK", "GMRINFRA", "BDL", "MID CAP", "SMALL CAP"],
    fill: {
      type: 'gradient'
    },
    legend: {
  ...
  var chart = new ApexCharts(document.querySelector("#gradientDonut2"), options);
  chart.render();
  var paper = chart.paper(); // donut with Pattern
